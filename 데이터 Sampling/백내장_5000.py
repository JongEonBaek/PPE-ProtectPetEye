...
# 경로 설정
folder_a = r"C:\Users\dataset\TL1_개_안구_일반\X_백내장\비성숙"
folder_b = r"C:\Users\dataset\TL1_개_안구_일반\X_백내장\성숙"
folder_c = r"C:\Users\dataset\TL1_개_안구_일반\X_백내장\초기"
folder_d = r"C:\Users\dataset\VL_개_안구_일반\X_백내장\비성숙"
folder_e = r"C:\Users\dataset\VL_개_안구_일반\X_백내장\성숙"
folder_f = r"C:\Users\dataset\VL_개_안구_일반\X_백내장\초기"
target_folder = r"C:\Users\dataset\최종 데이터셋/백내장"
...
if __name__ == "__main__":
    ...
    images_e, jsons_e = get_files(folder_e)
    images_f, jsons_f = get_files(folder_f)
    ...
    matched_e = match_files(images_e, jsons_e)
    matched_f = match_files(images_f, jsons_f)
